...
The input file for `BART geneset`, namely the `enhancer_prediction.txt` file generated by MARGE might have these two formats (depends on py2 or py3 version):
